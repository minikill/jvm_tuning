...
spark-submit --master k8s://$KUBERNETES_CLUSTER \
             ...
             --conf "spark.executor.extraJavaOptions=-Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=3100 -Dcom.sun.management.jmxremote.rmi.port=3101 -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false -Djava.rmi.server.hostname=127.0.0.1 -Dcom.amazonaws.sdk.disableCertChecking=true" \
